-- Participation design §9: allow the two event names the launch metrics need but
-- the CHECK list did not have yet (invite opens and album revisits). Everything
-- else the metrics need is already in the list.
BEGIN;
