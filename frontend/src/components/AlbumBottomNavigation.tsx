...
export default function AlbumBottomNavigation({
  onTop, onAddPhoto, onAddMemory, onShare, canAddPhoto = true, canAddMemory = true, newAlbumHref = "/",
  ...
  return (
    <nav className="album-bottom-navigation" aria-label="앨범 메뉴">
      ...
      <button type="button" onClick={onAddPhoto} disabled={!canAddPhoto}><ImagePlus size={17} /><span>사진 추가</span></button>
      <button type="button" onClick={onAddMemory} disabled={!canAddMemory}><PencilLine size={17} /><span>기억 남기기</span></button>
