 ...
 *
 * ★ 그림은 사진이 아니라 **선과 면으로 그린 모양**이다. 실제 사진을 넣으면 무엇이
 *   달라지는지가 그 사진에 가린다. 전부 장식이라 낭독기에는 읽히지 않는다.
  ...
  return (
    <div className="brand-value__art" aria-hidden="true">
      <div className="brand-value__pile">
        <span className="brand-value__pile-shot" />
        <span className="brand-value__pile-shot" />
        <span className="brand-value__pile-shot" />
      ...
      <div className="brand-value__book">
        ...
        <span className="brand-value__book-grid"><i /><i /><i /><i /></span>
...
function TogetherArt() {
  return (
    <div className="brand-value__art brand-value__art--together" aria-hidden="true">
      <span className="brand-value__together-shot" />
